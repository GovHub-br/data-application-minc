-- Bronze SALIC — sac__vfninccaprenuncia.
-- Origem: salic_bronze.sac__vfninccaprenuncia, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__vfninccaprenuncia") }}
