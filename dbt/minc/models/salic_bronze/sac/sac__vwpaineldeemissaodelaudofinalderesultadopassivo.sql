-- Bronze SALIC — sac__vwpaineldeemissaodelaudofinalderesultadopassivo.
-- Origem: salic_bronze.sac__vwpaineldeemissaodelaudofinalderesultadopassivo, onde tudo
-- chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__vwpaineldeemissaodelaudofinalderesultadopassivo") }}
