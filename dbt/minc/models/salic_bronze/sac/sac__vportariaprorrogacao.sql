-- Bronze SALIC — sac__vportariaprorrogacao.
-- Origem: salic_bronze.sac__vportariaprorrogacao, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__vportariaprorrogacao") }}
