-- Bronze SALIC — sac__vwpaineldocoordenador.
-- Origem: salic_bronze.sac__vwpaineldocoordenador, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__vwpaineldocoordenador") }}
