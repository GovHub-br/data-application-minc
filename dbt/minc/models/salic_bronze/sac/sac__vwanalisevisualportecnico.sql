-- Bronze SALIC — sac__vwanalisevisualportecnico.
-- Origem: salic_bronze.sac__vwanalisevisualportecnico, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__vwanalisevisualportecnico") }}
