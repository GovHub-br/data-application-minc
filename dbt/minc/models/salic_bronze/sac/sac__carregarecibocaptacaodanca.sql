-- Bronze SALIC — sac__carregarecibocaptacaodanca.
-- Origem: salic_bronze.sac__carregarecibocaptacaodanca, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__carregarecibocaptacaodanca") }}
