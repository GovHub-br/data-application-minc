-- Bronze SALIC — tabelas__sysdiagrams.
-- Origem: salic_bronze.tabelas__sysdiagrams, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_tabelas", "tabelas__sysdiagrams") }}
