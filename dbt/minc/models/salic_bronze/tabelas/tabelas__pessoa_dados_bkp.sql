-- Bronze SALIC — tabelas__pessoa_dados_bkp.
-- Origem: salic_bronze.tabelas__pessoa_dados_bkp, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_tabelas", "tabelas__pessoa_dados_bkp") }}
