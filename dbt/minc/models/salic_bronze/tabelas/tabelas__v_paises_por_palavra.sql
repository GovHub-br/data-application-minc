-- Bronze SALIC — tabelas__v_paises_por_palavra.
-- Origem: salic_bronze.tabelas__v_paises_por_palavra, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_tabelas", "tabelas__v_paises_por_palavra") }}
