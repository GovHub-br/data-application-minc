-- Bronze SALIC — tabelas__menus_minc11.
-- Origem: salic_bronze.tabelas__menus_minc11, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_tabelas", "tabelas__menus_minc11") }}
