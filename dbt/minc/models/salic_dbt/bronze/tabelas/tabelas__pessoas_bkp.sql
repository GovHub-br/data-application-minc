-- Bronze SALIC — tabelas__pessoas_bkp.
-- Origem: salic_bronze.tabelas__pessoas_bkp, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_tabelas", "tabelas__pessoas_bkp") }}
