-- Bronze SALIC — tabelas__pessoa_identificacoes.
-- Origem: salic_bronze.tabelas__pessoa_identificacoes, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_tabelas", "tabelas__pessoa_identificacoes") }}
