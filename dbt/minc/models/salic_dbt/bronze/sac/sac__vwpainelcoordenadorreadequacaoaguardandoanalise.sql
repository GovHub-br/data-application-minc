-- Bronze SALIC — sac__vwpainelcoordenadorreadequacaoaguardandoanalise.
-- Origem: salic_bronze.sac__vwpainelcoordenadorreadequacaoaguardandoanalise, onde tudo
-- chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__vwpainelcoordenadorreadequacaoaguardandoanalise") }}
