-- Bronze SALIC — sac__carregarecibocaptacaodanca2010.
-- Origem: salic_bronze.sac__carregarecibocaptacaodanca2010, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__carregarecibocaptacaodanca2010") }}
