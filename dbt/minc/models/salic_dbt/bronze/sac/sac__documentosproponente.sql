-- Bronze SALIC — sac__documentosproponente.
-- Origem: salic_bronze.sac__documentosproponente, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__documentosproponente") }}
