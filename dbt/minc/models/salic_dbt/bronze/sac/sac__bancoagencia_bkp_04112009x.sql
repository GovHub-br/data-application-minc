-- Bronze SALIC — sac__bancoagencia_bkp_04112009x.
-- Origem: salic_bronze.sac__bancoagencia_bkp_04112009x, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__bancoagencia_bkp_04112009x") }}
