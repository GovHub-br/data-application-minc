-- Bronze SALIC — sac__vrenunciaanoareaufgeral.
-- Origem: salic_bronze.sac__vrenunciaanoareaufgeral, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__vrenunciaanoareaufgeral") }}
