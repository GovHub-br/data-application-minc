-- Bronze SALIC — sac__carregarecibocaptacaodanca2013.
-- Origem: salic_bronze.sac__carregarecibocaptacaodanca2013, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__carregarecibocaptacaodanca2013") }}
