-- Bronze SALIC — sac__vcomparativoanomec.
-- Origem: salic_bronze.sac__vcomparativoanomec, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__vcomparativoanomec") }}
