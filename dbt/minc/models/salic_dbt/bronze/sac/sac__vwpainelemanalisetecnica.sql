-- Bronze SALIC — sac__vwpainelemanalisetecnica.
-- Origem: salic_bronze.sac__vwpainelemanalisetecnica, onde tudo chega como texto da
...
select
    ...
    _fatia
from {{ source("bronze_sac", "sac__vwpainelemanalisetecnica") }}
